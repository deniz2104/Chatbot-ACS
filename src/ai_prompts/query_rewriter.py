...
_REWRITE_PROMPT = (
    ...
    "- Reformulează întrebările de tipul 'ce poți spune despre X', 'spune-mi despre X', "
    "'ce știi despre X', 'povestește-mi despre X' ca întrebări directe: 'Cine este X?' "
    "dacă X este o persoană, sau 'Ce este X?' dacă X este un concept/instituție\n"
